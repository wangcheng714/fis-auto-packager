...
DATA;
    ...
    $fis_data = array(
        'line' => array(
            ...
            'navtile' => "982",
            'navmapurl' =>'http://map.baidu.com/mobile/#place/list/qt=s&wd=982&c=131&searchFlag=bigBox&nb_x=12947684.140728&nb_y=4861278.9010385&center_rank=1/vt=map&center_name=%E6%88%91%E7%9A%84%E4%BD%8D%E7%BD%AE&i=0' 
        ),
        'stations' => array(
            array(
                'no' => '01',
    ...
    case "lineway":
      $fis_data = array(
        'line' => array(
            'navtile' => "北京西站南广场",
            'navmapurl' =>'http://map.baidu.com/mobile/#place/detail/qt=inf&uid=3e513334f5eee5f82bd7ab58/vt=map&i=0' 
        ),
    ...
    $fis_data = array(
        'line' => array(
            ...
            'company' => '北京市地铁运营有限公司',
            'navtile' => "西二旗",
            'navmapurl' =>'http://map.baidu.com/mobile/#place/detail/qt=inf&uid=343ba820df4728442ad7abde/vt=map&i=0' 
        ),
        'stations' => array(
            array(
                'no' => '01',
    ...
    default:
        $data = file_get_contents('http://ditu.baidu.com/detail?newDetail=1&qt=ninf&uid=e116be546c69d062c91b9578&from=maponline&tn=m01&ie=utf-8&data_version=11252019');
        $fis_data['data'] = json_decode($data, true);
        break;
}
?>