{%style id="/widget/commentbtn/commentbtn.inline.less"%}/*评论入口样式*/
.place-widget-commentbtn {
...
.place-widget-commentbtn .combtn-icon {
  margin-right: 10px;
  text-align: center;
...
.place-widget-commentbtn .combtn-text {
  vertical-align: 15px;
  display: inline-block;
}
{%/style%}{%* 详情页UGC评论入口，我要评论按钮*%}
