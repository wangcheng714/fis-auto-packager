{%style id="/widget/captain/captain.inline.less"%}.place-widget-captain {
  position: relative;
  font-size: 14px;
}
.place-widget-captain .name {
  white-space: nowrap;
  overflow: hidden;
...
{%/style%}<div class="place-widget-captain {%if $ism%}movie{%/if%}">
