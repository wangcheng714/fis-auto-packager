{%style id="/widget/overview/overview.inline.less"%}/* 商户概况Widget */
.place-widget-overview {
  border-bottom: 1px solid #e1e1e1;
  overflow: hidden;
}
.place-widget-overview .title {
  margin: 0 5px 15px;
  font-size: 16px;
  color: #303235;
  line-height: 1.2;
}
.place-widget-overview .place-detailinfo-list {
  line-height: 20px;
  margin: 0px 22px;
  color: #6e6e6e;
}
.place-widget-overview li {
  margin-bottom: 25px;
  overflow: hidden;
}
.place-widget-overview li a {
  line-height: 20px;
  color: #6E6E6E;
}
.place-widget-overview li a p {
  color: #9D9D9D;
  margin-top: 10px;
  float: right;
}
.place-widget-overview .field {
  color: #c46221;
}
.place-widget-overview .more-btn {
...
.place-page-detail-moreoverview .place-widget-overview {
  border-bottom: none;
}
.place-page-detail-moreoverview .place-widget-overview .place-detailinfo-list {
  margin: 0px;
}
.place-page-detail-moreoverview .place-widget-overview .title,
.place-page-detail-moreoverview .place-widget-overview .more-btn {
  display: none;
}
{%/style%}{%* 商户概况 *%}
