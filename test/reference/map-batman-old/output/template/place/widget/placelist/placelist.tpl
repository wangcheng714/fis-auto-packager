{%style id="/widget/placelist/placelist.inline.less"%}/* 结果列表页 result list */
.place-widget-placelist {
  color: #3b3b3b;
  font-size: 1em;
...
.place-widget-placelist .mkr-icon {
  position: absolute;
  top: 10px;
  left: 15px;
}
.place-widget-placelist h4,
.place-widget-placelist p {
  -webkit-margin-before: 0;
  -webkit-margin-after: 0;
}
.place-widget-placelist li {
  white-space: nowrap;
  min-height: 45px;
  padding: 0 49px 11px 45px;
  border-bottom: 1px solid #ddd;
  background-color: #f9f9f9;
  position: relative;
}
.place-widget-placelist li.active {
...
.place-widget-placelist li .opt-icon {
  position: absolute;
  height: 1.32em;
  right: 24px;
  top: 54%;
...
.place-widget-placelist li .addr {
  margin-top: 2px;
}
.place-widget-placelist li .star {
  margin-top: 5px;
}
.place-widget-placelist li .price {
  margin-top: 3px;
}
.place-widget-placelist li p,
.place-widget-placelist li h4 {
  text-overflow: ellipsis;
  white-space: nowrap;
  overflow: hidden;
}
.place-widget-placelist li p .sm {
...
.place-widget-placelist li p .sm2 {
  margin-left: 0px;
}
.place-widget-placelist .acc-list .acc-item {
  display: none;
}
.place-widget-placelist .rl_go_dtl {
  position: absolute;
  background: url(/static/place/images/areo_54281fb.png) no-repeat 0 0;
...
.place-widget-placelist .rl_t_icon {
  height: 31px;
  width: 25px;
  position: absolute;
  top: 10px;
...
.place-widget-placelist .list-wrapper {
  border-top: none;
}
.place-widget-placelist .list-wrapper li p.padd {
  color: #4c4c4c;
}
.place-widget-placelist .list-wrapper li p {
  white-space: nowrap;
  color: #5e5e5e;
  font-size: 12px;
}
.place-widget-placelist .list-wrapper li p .scope-price {
  color: #f43f00;
  margin-right: 10px;
  font-weight: bold;
}
.place-widget-placelist .rl_li_title {
  font-weight: normal;
  font-size: 1.07em;
  max-width: 80%;
  display: inline-block;
...
.place-widget-placelist .rl_t_btn {
  height: 2.07em;
  line-height: 2.07em;
  color: #0072FF;
  max-width: 10em;
...
.place-widget-placelist em.rl_t_btn:last-child {
  max-width: 5.4em;
}
.place-widget-placelist .place-list {
  border-bottom: 1px solid #fff;
}
.place-widget-placelist .place-list strong.rl_li_title {
  max-width: 70%;
  display: inline-block;
  overflow: hidden;
  text-overflow: ellipsis;
}
.place-widget-placelist .place-list h4 {
  font-weight: normal;
}
.place-widget-placelist .list-wrapper .rl_opt {
  height: 2em;
  margin-top: -1em;
  line-height: 2.286em;
  padding-right: 2.5em;
...
.place-widget-placelist .rl_bl_rule {
  padding: 8px 2px 10px;
  background-color: #F2F2F2;
  text-align: center;
  line-height: 0;
}
.place-widget-placelist .rl_bl_rule .select_box {
  margin: 0 1.5%;
}
.place-widget-placelist .rl_bl_rule .sc_pos {
  margin-bottom: 4px;
  position: relative;
}
.place-widget-placelist .rl_title_icon {
  display: inline-block;
  width: 20px;
  height: 20px;
  vertical-align: middle;
  background: url(/static/place/images/setmyplace_icon_76e5911.png) no-repeat 0 -39px;
  background-size: 76px 59px;
}
.place-widget-placelist .rl_select_poi .rl_t_spoi {
  background-position: 1px -18px;
}
.place-widget-placelist li .rl_opt_btn {
  height: 11px;
  width: 16px;
  background: url(/static/place/images/setmyplace_icon_76e5911.png) -85px 0 no-repeat;
  -webkit-background-size: 76px 59px;
}
.place-widget-placelist li em.rl_opt_close {
  top: 4px;
  right: -4px;
  background-position: -42px 0;
}
.place-widget-placelist li .rl_opt_open {
  background-position: -58px 0;
  top: 4px;
  right: -4px;
}
.place-widget-placelist li.rl_sub_list {
  height: auto;
  padding: 0;
  overflow: hidden;
}
.place-widget-placelist .star_box {
  display: inline-block;
  height: 15px;
  width: 75px;
...
.place-widget-placelist .star_box .star_scroe {
  display: inline-block;
  height: 15px;
  background: url(/static/place/images/star_c90bcb4.png) repeat-x 0 -19px;
  background-size: 15px 33px;
}
.place-widget-placelist .mod_tel {
  margin: 8px 0 0;
  overflow: hidden;
}
.place-widget-placelist .mod_tel .mod_tel_content {
  overflow: hidden;
  text-overflow: ellipsis;
  width: 48%;
  color: #347e16;
  text-align: center;
  background: -webkit-gradient(linear, 0 100%, 0 0, from(#f1f1f1), to(#f7f7f7));
}
.place-widget-placelist .tel_num_ios {
  display: inline-block;
  width: 100%;
...
.place-widget-placelist .mod_tel .tel_icon_b {
  display: inline-block;
  height: 16px;
  width: 16px;
  background: url(/static/place/images/tel_icon2_78fc40d.png) 0 0 no-repeat;
  background-size: 16px 16px;
}
.place-widget-placelist div.mod_tel_content {
  display: inline-block;
  height: 25px;
  line-height: 25px;
...
.place-widget-placelist div.mod_tel_content a {
  color: #347e16;
  padding: 0;
  font-size: 13px;
}
.place-widget-placelist .pad div.mod_tel_content {
  width: 500px;
}
.place-widget-placelist .mod_tel .tel_num {
  border-radius: 0.25em;
  color: #347e16;
  font-size: 16px;
  word-wrap: normal;
...
.place-widget-placelist .mod_tel .tel_num_white {
  background-color: #fff;
  max-height: 5.714em;
  min-height: 2.786em;
  padding-left: 0.714em;
}
.place-widget-placelist .mod_tel .tel_num li {
  display: inline-block;
  /*min-height:2.571em;*/
...
.place-widget-placelist .mod_tel .tel_num li a {
  font-size: 16px;
  color: #518D3B;
  text-decoration: none;
}
.place-widget-placelist .mod_tel .btn-getline {
  display: inline-block;
  /*margin-right:5px;*/
...
.place-widget-placelist .btn-book {
  display: inline-block;
  line-height: 25px;
  min-width: 50px;
  text-align: center;
  ...
  background: -moz-linear-gradient(#f1f1f1, #f2f2f2);
  background: -webkit-linear-gradient(#f1f1f1, #f2f2f2);
  background: -o-linear-gradient(#f1f1f1, #f2f2f2);
  background: -ms-linear-gradient(#f1f1f1, #f2f2f2);
  background: linear-gradient(#f1f1f1, #f2f2f2);
...
.place-widget-placelist .premium_new {
  background: url('/static/place/images/list_sale_icon_a4ce387.png') 0 0 no-repeat;
}
.place-widget-placelist h4 em.place_ticket_icon,
.place-widget-placelist h4 em.place_groupon_icon,
.place-widget-placelist h4 em.place_seat_icon,
.place-widget-placelist .premium_new {
  background-size: 16px 16px;
  width: 16px;
  height: 16px;
...
.place-widget-placelist h4 em.place_groupon_icon {
  width: 16px;
  height: 16px;
  background: url(/static/place/images/tuan_icon_1bc0a17.png) 0 0 no-repeat;
  background-size: 16px 16px;
  margin-left: 1px;
}
.place-widget-placelist h4 em.place_seat_icon {
  background: url(/static/place/images/list_seat_icon_3df3b93.png) 0 0 no-repeat;
  background-size: 16px 16px;
  width: 16px;
  height: 16px;
}
.place-widget-placelist .showall-txt {
  height: 40px;
  line-height: 40px;
  padding-top: 10;
  text-align: center;
...
.place-widget-placelist .pagenav {
  padding: 12px;
  text-align: center;
  background-color: #f2f2f2;
}
.place-widget-placelist .pagenav .page-btn {
  display: inline-block;
  height: 27px;
  line-height: 27px;
  padding: 0 11px;
...
.place-widget-placelist .pagenav .unclick {
  color: #CCC;
  border: 1px solid #CACACA;
}
.place-widget-placelist .poi-list-onsales {
  margin-top: 7px;
  white-space: nowrap;
  color: #5e5e5e;
  width: 100%;
  ...
  height: 20px;
  background: #f8f8e8;
  border: solid 1px #e8e18e;
  border-radius: .25em;
  line-height: 20px;
  text-indent: .5em;
}
.place-widget-placelist .poi-list-onsales span {
  color: #f43f00;
}
.place-widget-placelist .place_streetscape_icon {
  background: url('/static/place/images/place_streetscape_icon_6d073c4.png') 0 0 no-repeat;
