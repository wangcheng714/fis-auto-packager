...
.marker-1,.marker-2,.marker-3,.marker-4,.marker-5,.marker-6,.marker-7,.marker-8,.marker-9,.marker-10,.marker-bus,.marker-sub{
	background: url(/static/place/images/markers_searchlist_3d21a2d.png) no-repeat 0 0;
	background-size: 25px 371px;
	height: 31px;
	width: 25px;
