...
button.btn-h35 {
  ...
  color: white;
  text-align: center;
  background: url(/static/taxi/images/bg-btn-h35_a548b0e.png) repeat-x 0 0;
  background-size: 1px 68px;
  border: 1px solid #4678d3;
  border-radius: 3px;
}
button.btn-h35[disabled=disabled] {
...
#wrapper > [id^="taxi-pagelet-"] {
  position: absolute;
  width: 100%;
  height: 100%;
  box-sizing: border-box;
}
#wrapper > [id^="taxi-pagelet-"] > [class^="taxi-widget-"] {
  height: 100%;
}
</style>
