...
.index-widget-navebox .se-box {
  width: 100%;
  background-color: #f4f4f4;
}
.index-widget-navebox .se-box .ipt-icon {
  height: 21px;
  width: 16px;
  position: absolute;
  top: 6px;
...
.index-widget-navebox .se-box .ipt-icon.start {
  background-position: 0px -30px;
  /*background-color: #3ac310;*/

}
.index-widget-navebox .se-box .ipt-icon.end {
...
.index-widget-navebox .new-se-tab {
  float: left;
  width: 50%;
  color: #d5d5d5;
  text-align: center;
...
.index-widget-navebox .new-se-tab-r {
  border-left: 1px solid #3f4245;
  width: 49.6%;
}
.index-widget-navebox .se-wrap {
  padding: 8px 8px;
  /*border-bottom: 1px solid #cecece;background-color: #ededed;*/

  position: relative;
}
.index-widget-navebox .se-wrap .se-poi-form {
  height: 36px;
  background-color: #ffffff;
  position: relative;
}
.index-widget-navebox .se-wrap .btn-clear {
  position: absolute;
  right: 0.286em;
  top: 50%;
  margin-top: -0.714em;
...
.index-widget-navebox .se-wrap input {
  width: 100%;
  height: 100%;
  /*padding-left:0.25em;*/
...
.index-widget-navebox .se-wrap input.geo {
  color: #4C78CE;
}
.index-widget-navebox .se-inner {
  height: 32px;
  padding-left: 26px;
  position: relative;
...
.index-widget-navebox .se-poi-form input {
  padding: 5px;
  height: 27px;
  /*line-height: 27px;*/

}
.index-widget-navebox .se-poi table {
  border: 1px solid #9a9a9a;
  background: #fff;
}
.index-widget-navebox #se_poi_submit {
  height: 36px;
  width: 49px;
  border-left: 1px solid #9a9a9a;
  background: -webkit-gradient(linear, 0 100%, 0 0, from(#e7e7e7), to(#f5f5f5));
}
.index-widget-navebox #se_poi .active {
  background: none;
  background-color: #e7e7e7;
}
.index-widget-navebox .se-btn b {
...
.index-widget-navebox .se-city span {
  display: inline-block;
  height: 22px;
  line-height: 22px;
  white-space: nowrap;
...
.index-widget-navebox .se-city span:after {
  content: "";
  position: absolute;
  width: 7px;
  height: 4px;
...
.index-widget-navebox .route-pic {
  background: url(/static/third/images/2_0fcd474.png) no-repeat;
...
.index-widget-navebox .se-dir-form {
  position: relative;
}
.index-widget-navebox .se-dir-form input {
  height: 2.071em;
}
.index-widget-navebox #se_dir_submit {
  width: 35px;
  height: 70px;
  border: 1px solid #9a9a9a;
...
.index-widget-navebox #se_dir_reverse {
  width: 39px;
  height: 45px;
  border: 1px solid #9a9a9a;
  -webkit-border-radius: 2px;
  margin: -2px 6px 0 0;
  background-image: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#f6f6f6), to(#dfdfdf), color-stop(0.5, #eeeeee));
}
.index-widget-navebox #se_dir_reverse.active {
  background: #e7e7e7;
  -webkit-box-shadow: inset 0px 0px 2px #e3e3e3;
}
.index-widget-navebox .se-rev-icon {
  width: 18px;
  height: 25px;
  margin-top: 10px;
  margin-left: 9px;
...
.index-widget-navebox .se-bus-btn,
.index-widget-navebox .se-drive-btn,
.index-widget-navebox .se-walk-btn {
  float: left;
  margin-top: 8px;
  width: 32%;
  height: 32px;
...
.index-widget-navebox .se-bus-btn.active {
  background: #f5f6f7;
}
.index-widget-navebox .se-drive-btn.active {
  background: #f5f6f7;
}
.index-widget-navebox .se-bus-btn {
  margin-right: 2%;
}
.index-widget-navebox .se-bus-btn .se-bus-icon {
  display: inline-block;
  margin-right: 9px;
  height: 14px;
  width: 14px;
...
.index-widget-navebox .se-drive-btn .se-drive-icon {
  display: inline-block;
  margin-right: 9px;
  height: 14px;
  width: 14px;
...
.index-widget-navebox .se-walk-btn .se-walk-icon {
  display: inline-block;
  margin-right: 7px;
  height: 14px;
  width: 14px;
...
.index-widget-navebox .se-tabgroup .active {
  background-color: #373b42;
}
.index-widget-navebox .se-walk-btn {
  margin-left: 2%;
}
.index-widget-navebox .route-wrapper {
  padding: 10px 8px;
  color: #515a64;
}
.index-widget-navebox .route-wrapper .nb-station {
  font-size: 13px;
}
.index-widget-navebox .route-wrapper .st {
  display: inline-block;
  height: 28px;
  line-height: 28px;
  padding: 0 10px;
...
.index-widget-navebox .route-wrapper .sw-btn {
  margin-top: 14px;
  height: 33px;
  line-height: 33px;
  border: 1px solid #adadad;
...
.index-widget-navebox .route-wrapper .sw-btn.active {
  background: #F2F2F2;
}
.index-widget-navebox .route-wrapper .sw-btn em {
  display: inline-block;
  width: 14px;
  height: 16px;
  vertical-align: middle;
