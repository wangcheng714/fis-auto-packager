...
define('subway:static/js/model/subway.js', function (require, exports, module) {
    ...
    module.exports = {
        ...
        // 所以，以后增加城市也需要修改两处
        xmlUri: {
            "beijing"   : '/mobile/simple' + __uri('/static/xml/sw_beijing.xml'),
            "shanghai"  : '/mobile/simple' + __uri('/static/xml/sw_shanghai.xml'),
            "guangzhou" : '/mobile/simple' + __uri('/static/xml/sw_guangzhou.xml'),
            "shenzhen"  : '/mobile/simple' + __uri('/static/xml/sw_shenzhen.xml'),
            "hongkong"  : '/mobile/simple' + __uri('/static/xml/sw_hongkong.xml'),
            "chengdu"   : '/mobile/simple' + __uri('/static/xml/sw_chengdu.xml'),
            "changchun" : '/mobile/simple' + __uri('/static/xml/sw_changchun.xml'),
            "chongqing" : '/mobile/simple' + __uri('/static/xml/sw_chongqing.xml'),
            "dalian"    : '/mobile/simple' + __uri('/static/xml/sw_dalian.xml'),
            "foshan"    : '/mobile/simple' + __uri('/static/xml/sw_foshan.xml'),
            "hangzhou"  : '/mobile/simple' + __uri('/static/xml/sw_hangzhou.xml'),
            "kunming"   : '/mobile/simple' + __uri('/static/xml/sw_kunming.xml'),
            "nanjing"   : '/mobile/simple' + __uri('/static/xml/sw_nanjing.xml'),
            "shenyang"  : '/mobile/simple' + __uri('/static/xml/sw_shenyang.xml'),
            "suzhou"    : '/mobile/simple' + __uri('/static/xml/sw_suzhou.xml'),
            "tianjin"   : '/mobile/simple' + __uri('/static/xml/sw_tianjin.xml'),
            "wuhan"     : '/mobile/simple' + __uri('/static/xml/sw_wuhan.xml'),
            "xian"      : '/mobile/simple' + __uri('/static/xml/sw_xian.xml'),
            "haerbin"   : '/mobile/simple' + __uri('/static/xml/sw_haerbin.xml')
        },
