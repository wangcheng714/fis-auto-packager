...
<header class="common-widget-header"  style="display:none">
    <div class="nav">
        ...
        <div class="side-r">
            <a href="javascript:void(0);" target="_blank" id="header_install_button" class="header_install_button" uid="{%$data.content.uid%}" data-log="{code:{%$COM_STAT_CODE.HEADER_APP_DOWN%}}">
                下载客户端
            </a>  
        </div>
    </div>
