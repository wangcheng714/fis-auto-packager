...
<meta name="apple-mobile-web-app-capable" content="yes"/><link rel="apple-touch-startup-image"   href="ui/images/startup_320_460.jpg" />
<link rel="apple-touch-icon-precomposed" href="ui/images/logo.png"/><title>百度地图</title>
{%require name="common:static/css/reset.inline.css"%}
{%require name="common:static/css/base.inline.css"%}
...
{%script%}
        ...
        {%/script%}
{%require name='index:page/waitforloc.tpl'%}{%/body%}
{%/html%}