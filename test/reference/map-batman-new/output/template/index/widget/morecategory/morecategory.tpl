...
{%$cateinfo = $data|f_escape_xml%}
{%for $i = 0; $i < count($cateinfo.other); $i++ %}
{%$key = $cateinfo.other[$i]|f_escape_xml%}
{%$cate = $cateinfo.content[$key]|f_escape_xml%}
...
{%$word = $cate.subcate[$j].name|f_escape_xml%}
{%$id = $cate.id|f_escape_xml%}
{%if $index%2==0 %}
<ul class="sublist">
{%/if%}
<li>
