...
{%$list = $data.result.list|f_escape_xml%}
...
<div class='exchange-gift-all'>总量{%$list[$i].total_num|f_escape_xml%}件 剩余{%$list[$i].total_num-$list[$i].exchange_num|f_escape_xml%}件</div>
...
<div class='exchange-gift-img'><img src={%$list[i-1].pic_url|f_escape_path%}></div>
<div class='exchange-gift-contain'>
<div class='exchange-gift-title'>{%$list[i-1].title|f_escape_xml%}</div>
<div class='exchange-gift-des'>{%$list[i-1].title|f_escape_xml%}</div>
<div class='exchange-gift-all'>总量{%$list[i-1].total_num|f_escape_xml%}件 剩余{%$list[i-1].total_num-$list[i-1].exchange_num|f_escape_xml%}件</div>
<div class='exchange-gift-buy'>兑换（-{%$list[i-1].need_integral|f_escape_xml%}积分）</div>
</div>
</li>
{%/if%}
</ul>
