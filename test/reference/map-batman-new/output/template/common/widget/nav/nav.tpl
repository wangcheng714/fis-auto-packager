...
<a  id="nav_maplink" href="{%$mapLink|f_escape_xml%}" data-log="{code:{%$COM_STAT_CODE.NAV_VIEW_MAP|f_escape_xml%}, pagetype:'{%$pageType|f_escape_xml%}', wd: '{%$title|f_escape_xml%}', name: '{%$bname|f_escape_xml%}', srcname: '{%$srcname|f_escape_xml%}' }">
