{%style id="/widget/basicinfo/basicinfo.inline.less"%}.place-widget-basic-info{border:1px #B0B0B0 solid;background-color:#fff;border-radius:.25em;padding:.535em .535em .535em 10em;position:relative;min-height:6.679em;color:#555}.place-widget-basic-info .dtl-img{border:1px solid #A3A3A3;position:absolute;width:8.857em;height:6.607em;left:.535em;top:7px;float:left;margin-right:9px}.place-widget-basic-info .dtl-img img{width:8.857em;height:6.607em}.place-widget-basic-info .dtl-plinfo-con{font-size:13px;margin-top:.571em}.place-widget-basic-info .star-box-l{background:url(/mobile/simple/static/place/images/star_a9ede79.png) repeat-x 0 0;background-size:15px 33px;vertical-align:middle;margin-top:-.179em;display:inline-block;height:16px;width:75px}.place-widget-basic-info .star-score{background:url(/mobile/simple/static/place/images/star_a9ede79.png) repeat-x 0 -19px;background-size:15px 33px;height:15px;vertical-align:top;display:inline-block;height:16px}.place-widget-basic-info .dtl-plinfo-item{line-height:1.714em}.place-widget-basic-info .special,.place-widget-basic-info .realtime{color:#f43f00;margin-right:3px;font-weight:700}.place-widget-basic-info .place_rating_source{position:absolute;word-break:break-all;font-family:"微软雅黑";color:#000;font-size:12px;margin-left:2px}.place-widget-basic-info .photodetail-count{position:absolute;right:0;bottom:0}.place-widget-basic-info .photodetail-count-num{width:18px;height:18px;line-height:18px;text-align:center;background:#757575;color:#fefefe;display:block}{%/style%}{%* 如果src_name值在规定范围内且 content.ext.detail_info不为空则显示 *%}
...
{%else%}
<img src="/mobile/simple/static/place/images/no_img_039c24b.png"/>
{%/if%}
</div>
