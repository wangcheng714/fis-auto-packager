...
{%$len = mb_strlen($movie_info.movie_message,"utf-8")%}
{%if $len>30%}
...
{%$len = mb_strlen($movie_info.movie_description,"utf-8")%}
{%if $len>65%}
...
{%if $extd.timetable%}
{%$timeCount = count($extd.timetable)%}
