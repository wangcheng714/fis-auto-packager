...
<li class="needsclick">
<p id="{%$list.dishCategoryId|f_escape_xml%}" class="dish-name needsclick">{%$list.dishCategoryName|f_escape_xml%}</p>
</li>
{%/foreach%}
</ul>
</div>
