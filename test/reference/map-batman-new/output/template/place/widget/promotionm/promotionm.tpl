...
<a href="{%$tuan.groupon[0].groupon_webapp_url|f_escape_xml%}&uid={%$data.content.uid|f_escape_path%}&from=map_webapp_detail&loc=({%$point.x|f_escape_path%},{%$point.y|f_escape_path%})" data-log="{code:{%$STAT_CODE.PLACE_DETAIL_GROUPON_CLICK|f_escape_xml%}, wd:'{%$widget_data.src_name|f_escape_xml%}', name:'{%$widget_data.name|f_escape_xml%}'}">
{%if !empty($premium)%}
...
<li class="stitle">{%$tuan.groupon[0].groupon_short_title|f_escape_xml%}</li>
<li class="title">{%$tuan.groupon[0].groupon_title|f_escape_xml%}</li>
</ul>
<div class="groupon_price">
<div class="price">
<div style="text-align:right;">
<span>￥</span><span>{%$tuan.groupon[0].groupon_price|f_escape_xml%}元</span>
</div>
</div>
</div>
<div class="clear"></div>
...
{%/if%}
{%if !empty($premium)%}
<a href="{%$widget_data.data.ext.detail_info.promotion_uri|cat:'&detail_part=premium&item_index=0'%}" data-log="{code:{%$STAT_CODE.PLACE_DETAIL_PREMIUM_CLICK|f_escape_xml%}, wd:'{%$widget_data.src_name|f_escape_xml%}', name:'{%$widget_data.name|f_escape_xml%}'}">
{%if !empty($tuan.groupon)%}
