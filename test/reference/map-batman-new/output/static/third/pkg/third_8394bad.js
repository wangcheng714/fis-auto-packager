...
;define('third:widget/footer/footer.js', function(require, exports, module){
...
module.exports = {
    ...
    bind : function () {
        ...
        listener.on('common', 'sizechange', function (argument) {
            _this._appReSize();
        }, this);
...
module.exports = {
    ...
    bind : function () {
        var _this = this;
        $('.third-nearby [jsaction]').on('click', function (evt) {
            var target = $(evt.currentTarget);
            _this.search(target.attr('userdata'));
        });
    },
...
;define('third:widget/searchbutton/searchbutton.js', function(require, exports, module){
...
;define('third:widget/searchline/searchboxmodel.js', function(require, exports, module){
...
;define('third:widget/searchline/searchline.js', function(require, exports, module){
...
module.exports = {
    ...
    render : function () {
        ...
        me.model  = require("third:widget/searchline/searchboxmodel.js");
    ...
    */
    ...
    _poiSubmit : function (opts) {
        ...
        //第三方的公交检索量
        stat.addCookieStat(STAT_CODE.STAT_TRANSIT_PLAN_CLICK);
