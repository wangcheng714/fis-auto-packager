define('walk:widget/helper/maphelper.js', function(require, exports, module){
...
module.exports = {
    ...
    selectStep: function(step){
        ...
        mapView.iwController.get(mapConst.IW_WLK).switchTo(step);
    ...
    addPopInfoWin:function(){
        ...
        var iwOverlay = mapView.iwController.get(mapConst.IW_WLK);
        iwOverlay.setData(mapConst.IW_WLK, {
            json: this.popInfos,
        ...
        listener.on('infowindow.' + mapConst.IW_WLK, 'click', function (name, evt) {
            var id = evt.id;

            switch(id) {
                case 'iw-c':
                    // 跳入驾车列表
                    stat.addCookieStat(COM_STAT_CODE.MAP_IW_WLK_LIST);
    ...
    getClickHandler:function(step){
        ...
        return function(){
            // 路线节点marker点击量
            stat.addStat(COM_STAT_CODE.MAP_WLK_DIR_MARKER_CLICK);
    ...
    removeCurrentOverlay: function(){
        ...
        mapView.iwController.get(mapConst.IW_WLK).hide();
        mapView.displayId = '';
    }
};
