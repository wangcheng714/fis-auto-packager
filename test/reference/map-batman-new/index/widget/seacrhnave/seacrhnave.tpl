    ...
    <div id="se_box" class="se-box">
        <div id="se_wrap" class="se-wrap">
                        ...
                        <td width="100%">
                            <div class="se-inner" style="margin-bottom: 6px;">
                                ...
                                <form id="se_start_form" class="se-dir-form">
                                    <input type="text" key="start" id="se_txt_start" class="se_txt_start" />
                                </form>
                            </div>
                            <div class="se-inner">
            ...
            <div class='tactics' style="text-align:center;"> 
                 <span class="se-bus-btn se-btn-tr clickable" data-value="1"><em class="route-pic se-bus-icon"></em>公交</span>
                 <span class="se-drive-btn se-btn-tr clickable" data-value="2"><em class="route-pic se-drive-icon"></em>驾车</span> 
                 <span class="se-walk-btn se-btn-tr clickable" data-value="3"><em class="route-pic se-walk-icon"></em>步行</span>
          </div> 
        </div>
    </div>
</div>
