...
.index-widget-bank .hd h2 {
  ...
  font-weight: 400;
  padding-left: 36px;
  background: url(/static/index/images/npush-icon_41fdc4d.png) 0 -59px no-repeat;
...
.index-widget-bank .icon {
  ...
  height: 29px;
  margin: 0 auto;
  background: url(/static/index/images/npush-icon-new_0c82978.png) no-repeat;
...
{%script%}
    (require("index:widget/nearpush/bank.js")).init("{%$pagename%}");
{%/script%}