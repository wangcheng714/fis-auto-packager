...
.index-widget-cater .hd h2 {
  ...
  font-weight: 400;
  padding-left: 36px;
  background: url(/static/index/images/npush-icon_41fdc4d.png) 1px 5px no-repeat;
...
.index-widget-cater .icon {
  ...
  height: 24px;
  width: 15px;
  background: url(/static/index/images/npush-icon_41fdc4d.png) no-repeat;
...
{%script%}
    (require("index:widget/nearpush/cater.js")).init("{%$pagename%}");
{%/script%}