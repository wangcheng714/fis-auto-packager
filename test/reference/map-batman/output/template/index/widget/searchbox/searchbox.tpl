...
.index-widget-searchbox .se-tab .new-se-tab-icon {
...
.index-widget-searchbox .se-tab .icon-l {
  height: 35px;
  width: 12px;
  background-position: 0 10px;
}
.index-widget-searchbox .se-tab .icon-m {
  height: 30px;
  width: 12px;
  background-position: 0 -18px;
}
.index-widget-searchbox .se-tab .icon-r {
  height: 30px;
  width: 14px;
