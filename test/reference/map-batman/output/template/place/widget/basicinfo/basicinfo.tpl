{%style id="/widget/basicinfo/basicinfo.inline.less"%}.place-widget-basic-info {
...
.place-widget-basic-info .dtl-img {
...
.place-widget-basic-info .dtl-img img {
  width: 8.857em;
  height: 6.607em;
}
.place-widget-basic-info .dtl-plinfo-con {
  font-size: 13px;
  margin-top: .571em;
}
.place-widget-basic-info .star-box-l {
...
.place-widget-basic-info .star-score {
...
.place-widget-basic-info .dtl-plinfo-item {
  line-height: 1.714em;
}
.place-widget-basic-info .special,
.place-widget-basic-info .realtime {
  color: #f43f00;
  margin-right: 3px;
  font-weight: bold;
}
.place-widget-basic-info .place_rating_source {
  position: absolute;
