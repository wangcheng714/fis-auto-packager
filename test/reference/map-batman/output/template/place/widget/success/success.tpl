{%style id="/widget/success/success.inline.less"%}.ordersuccess {
  font-size: 14px;
  color: #737373;
  position: relative;
}
.ordersuccess .success-notice {
  background: #f7f7f7;
  height: 90px;
...
.ordersuccess .success-notice .success-img {
  background: url(/static/place/images/book_success_e393d89.png) 0 0 no-repeat;
...
.ordersuccess .success-notice p {
  padding-top: 27px;
  width: 220px;
}
.ordersuccess .success-notice .book-success {
  font-size: 16px;
  font-weight: bold;
  color: #40b011;
  display: block;
...
.ordersuccess .hotel-info {
  border: 1px solid #dedede;
  margin: 10px 8px 15px 8px;
  border-radius: 3px;
  background: #fafafa;
}
.ordersuccess .hotel-info table {
  color: #333;
  width: 97%;
  margin: 0 1.5%;
}
.ordersuccess .hotel-info td.left {
  width: 35%;
  color: #737373;
  text-align: right;
}
.ordersuccess .hotel-info td {
...
.ordersuccess .hotel-info tr.last td {
  border-bottom: none;
  box-shadow: none;
  -webkit-box-shadow: none;
}
.ordersuccess .hotel-info .total-price {
  color: #ff5026;
}
{%/style%}<div id="orderSuccess" class="ordersuccess">
