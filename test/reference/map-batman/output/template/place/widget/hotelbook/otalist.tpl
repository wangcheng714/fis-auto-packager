...
<div class="ota-result">
    ...
    <ul class="ota-list">
        ...
        {%if $smarty.section.otaprice.index<3%}
            <li class="ota-item" ota_book_url="{%$widget_data.room_price.price_info[otaprice].ota_book_url%}" index="{%$smarty.section.otaprice.index%}">
        {%else%}
            <li class="ota-item hide" ota_book_url="{%$widget_data.room_price.price_info[otaprice].ota_book_url%}" index="{%$smarty.section.otaprice.index%}">
        {%/if%}
                ...
                {%if $widget_data.room_price.price_info[otaprice].bd_booktype==1%}
                    <span class="ota-bookbtn"
                          data-url="{%$widget_data.room_price.price_info[otaprice].ota_book_url%}"
                          data-price="{%$widget_data.room_price.price_info[otaprice].ota_price%}"
                          data-bonus="{%$widget_data.room_price.price_info[otaprice].ota_coupon_price%}"></span>
                {%elseif $widget_data.room_price.price_info[otaprice].bd_booktype==2%}
                    <a href="tel:{%$widget_data.room_price.price_info[otaprice].ota_phone%}" phone="{%$widget_data.room_price.price_info[otaprice].ota_phone%}" class="ota-bookbtn ota-bookbtn-tel"></a>
