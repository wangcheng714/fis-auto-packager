{%style id="/widget/takeoutdetailnav/takeoutdetailnav.inline.less"%}/**
 * @fileoverview 返回按钮css
 */
.place-widget-takeout-detail-nav {
  height: 51px;
  background: #FFF;
  position: relative;
...
.place-widget-takeout-detail-nav > div {
  display: inline-block;
}
.place-widget-takeout-detail-nav .base-btn {
  height: 51px;
  line-height: 51px;
...
/* 查看地图按钮 */
.place-widget-takeout-detail-nav .meau-btn {
  position: absolute;
  top: 10px;
  right: 8px;
  padding: 0 10px;
...
.place-widget-takeout-detail-nav .back-btn {
  position: absolute;
  width: 50px;
}
.place-widget-takeout-detail-nav .back-btn:before {
...
.place-widget-takeout-detail-nav .title {
  width: 100%;
  line-height: 51px;
  font-size: 16px;
  color: #373A3D;
...
.place-widget-takeout-detail-nav .title span {
  margin: 0 70px;
  color: #373A3D;
  display: block;
  overflow: hidden;
...
.place-widget-takeout-detail-nav .back-btn:active {
  background: #e7e7e7;
}
.place-widget-takeout-detail-nav .meau-btn:active {
  background: #e7e7e7;
}
